function [outdata]=API_ChangeDirectionTest(ptarget,rtarget,pcurrent,rcurrent,ts)
warning off
...
fprintf('total trajectory time  is %.2fs\n', TotalTime);
    ...
    outdata = runSimulation(ptarget,rcurrent,blockCorners,debuglevel,time1,TotalTime,SABiRx,Rneedle,sys);
