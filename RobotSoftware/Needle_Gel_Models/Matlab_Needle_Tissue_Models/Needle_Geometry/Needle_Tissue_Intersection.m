function [TissueState NeedlePtList] = Needle_Tissue_Intersection(structTissueData,structNeedleGeometry,structNeedleData,N)
%#codegen
...
NeedlePtList = Needle_Shape(structNeedleData,structNeedleGeometry,N);
