...
plot(time,wrenchModeled(1,:),time,wrenchModeled(2,:),time,wrenchModeled(3,:));

torquesHand = figure;
plot(time,wrenchModeled(4,:),time,wrenchModeled(5,:),time,wrenchModeled(6,:));
